...
1. [General_Principles] (#general-principles)
2. [Table Naming Coventions] (#table-naming-conventions)
   - [Bronze Rules] (#bronze-rules)
   - [Silver Rules] (#silver-rules)
   - [Gold Rules] (#gold-rules)
3. [Colums Naming Conventions] (#column-naming-conventions)
...
- Avoid Reserved Words: Do not use SQL resesrved words as object names.
...
### **Technical Columns**
- All technical columns must start with the prefix 'dwh_', followed by a descriptive
name indicating the column's purpose.
- **'dwh_<column_name>'**
  - 'dwh': Prefix exclusively for system-generated metadata.
  - '<column_name>': Descriptive name indicating the column's purpose.
  - Example: 'dwh_load_date' -> System-generated column used to store the date when the
  record was loaded.
...
- **'load_<layer>'**
  - "<layer>": Represents the layer being loaded, such as 'bronze', 'silver', or
  'gold'.
  - Example:
